        ...
        <div class="tablelist">
            ...
            <form action="{{route('addproductsubmit')}}" method="POST" class="form-container" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="slug" id="slug" placeholder="Enter product slug" required />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="old_price" id="old_price" placeholder="Enter old price" required />
                </div>
               
                <div class="form-group">
                    <label for="short_description">Short Description</label>
                    <textarea name="short_description" id="short_description" rows="3" placeholder="Enter short description"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="shipping_returns" id="shipping_returns" placeholder="Enter shipping and returns details" required />
                </div>
